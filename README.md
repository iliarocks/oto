...
4. After changing the contents of your folder, pull to refresh or use **Settings → Refresh Library**. A notice in the library links to any files that couldn't be read. **Settings**, opened from the gear at the top left, shows the selected folder and lets you choose another. Its About section links to Privacy and Support.
