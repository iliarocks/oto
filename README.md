...
3. Tap the compact player for seeking, previous/next, and AirPlay. Previous restarts the song after three seconds; otherwise it moves back one track.
4. After changing the contents of your folder, use **Library Options → Refresh Library**. **Music Folder** shows any files that couldn't be read.
